...
def get_conn():
    """
    Cria e retorna uma conexão segura com o banco MySQL na Aiven.
    """
    try:
        caminho_ca = os.path.abspath(st.secrets["SSL_CA_PATH"])
...
if pesquisar:
    ...
    if not df.empty:
        ...
        col2.download_button("📗 Excel", data=excel_buffer.getvalue(), file_name='relatorio.xlsx')
    ...
    st.info("🧭 Selecione filtros e clique em **Pesquisar** para gerar o relatório.")
