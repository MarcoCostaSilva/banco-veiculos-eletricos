...
# ------------------- CONEXÃO SEGURA AIVEN (CACHEADA) -------------------
@st.cache_resource
def get_conn():
    """
    Retorna conexão segura com o banco de dados MySQL da Aiven,
    utilizando parâmetros armazenados em st.secrets e SSL com ca.pem.
    """
...
@st.cache_data
def carregar(sql):
    """Executa consultas SQL e retorna DataFrame cacheado."""
...
if limpar:
    ...
    st.rerun()  # atualizado para nova API
...
if pesquisar:
    ...
    st.info("Selecione os filtros e clique em Pesquisar para gerar o mapa.")
