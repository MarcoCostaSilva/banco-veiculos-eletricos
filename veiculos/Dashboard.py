...
def get_conn():
    """
    Cria e mantém uma conexão persistente com o banco MySQL da Aiven
    usando certificado SSL indicado no secrets.toml
    """
...
if pesquisar:
    ...
    st.info("🧭 Selecione os filtros desejados e clique em **Pesquisar** para exibir o mapa.")
